package com.neu.x.leetcode.airbnb.HostCrowding;

import java.util.*;

/**
 * @ description:HostCrowding
 * @ author: guojiang.x
 * @ created: 2019-02-25 16:01
 */
public class Solution {
    ...
    private static Listing getListingFromString(String s) {
    ...
    private static List<String> getSortedPages(ArrayList<String> listings, int perPage) {
    ...
    private List<String> displayPages(List<String> input, int pageSize) {
    ...
    private List<String> displayPages_2(List<String> input, int pageSize) {
        List<String> res = new ArrayList<>();
        Iterator<String> iter = input.iterator();
        Set<String> set = new HashSet<>();
        boolean reachEnd = false;
    ...
    public static void main(String[] args) {
        ...
        Collections.addAll(inputs, tests);
